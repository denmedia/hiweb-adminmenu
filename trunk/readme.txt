...
= Русский =
Просто зайдите в админ-панель и кликните внизу админ-меню кнопку "Edit menu" и методом перетащите пункты меню, включая сепараторы, в нужное место. Положение автоматически сохраниться.
